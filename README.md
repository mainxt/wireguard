...
4. Отвечаем на все вопросы утвердительно, попррсит нажать любую клавишу и попросит ввести имя клиента (Client name) пишем **wireguard**, соглашаемся с предложенными IP-адресами, послое чего будет отображен QR-код. 
