...
2. Выбираем 1-й пункт «**Add a new user**», далее пишем к примеру **wireguard-win** (не более 15 символов). Появится QR-код, но нам теперь нужен не он, а путь к конфигурационному файлу под ним. Открываем содержимое файла следующей командой:
